...
20  CALL RANLUX (RVECTOR, 2)
  !WRITE(*,*) RVECTOR(1), RVECTOR(2), RVECTOR(3)
  u = RVECTOR(1) * p4
  !
  v = RVECTOR(2)
...
!THIS USED TO BE A STANDALONE MODULE toms668
...
!     ..
!     .. Array Arguments ..
      REAL, DIMENSION(ncat), INTENT(IN):: p
      INTEGER, DIMENSION(ncat), INTENT(OUT):: ix
!     ..
!     .. Local Scalars ..
      REAL prob,ptotal,sum
      INTEGER i,icat,ntot
!     ..
!     .. External Functions ..
      INTEGER ignbin
...
!     Finished
      ...
      SUBROUTINE Dirichlet(k,D,X)
          ...
          REAL, DIMENSION(k), INTENT(IN):: D    !Vector of parameters
          REAL, DIMENSION(k), INTENT(OUT):: X   !Output
